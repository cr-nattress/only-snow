...
export const chaseRegions: ChaseRegion[] = [
  ...
  },
  {
    ...
    forecastTotal: "4-8\"",
    dates: "Feb 12-13",
    resorts: ["Camelback", "Blue Mountain", "Jack Frost"],
  ...
  },
  {
    ...
    forecastTotal: "8-12\"",
    dates: "Feb 11-13",
    resorts: ["Stowe", "Jay Peak", "Bolton Valley"],
    description: "Lake-effect enhanced snowfall across the Greens.",
    bestAirport: "BTV",
    lat: 44.53,
    lng: -72.78,
    passTypes: ["epic", "ikon"],
  ...
  },
  {
    ...
    forecastTotal: "5-9\"",
    dates: "Feb 11-12",
    resorts: ["Loon", "Cannon", "Wildcat"],
    description: "Nor'easter clips the Whites.",
    bestAirport: "MHT",
    lat: 44.10,
    lng: -71.45,
    passTypes: ["epic", "ikon"],
  ...
  },
  {
    ...
    forecastTotal: "1-3\"",
    dates: "",
    resorts: ["Snowshoe", "Canaan Valley", "Timberline"],
  ...
  },
  {
    ...
    forecastTotal: "4-7\"",
    dates: "Feb 12-13",
    resorts: ["Hunter", "Windham", "Belleayre"],
    description: "Nor'easter brings moderate snow.",
    bestAirport: "ALB",
    lat: 42.13,
    lng: -74.25,
    passTypes: ["epic", "ikon"],
