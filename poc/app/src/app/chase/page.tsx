    ...
    <div className="min-h-screen">
      ...
      {view === "region" && region && (
        <div className="px-4 md:px-6 lg:px-8 py-3 lg:py-4 space-y-3 lg:space-y-4">
          ...
          <div className={`rounded-xl border ${severityConfig[region.severity].border} ${severityConfig[region.severity].bg} px-4 md:px-5 lg:px-6 py-3 lg:py-4`}>
            <div className="flex items-center gap-2 mb-2">
              <span>{severityConfig[region.severity].icon}</span>
              <span className={`text-xs lg:text-sm font-bold ${severityConfig[region.severity].text}`}>
                {region.dates} STORM
              </span>
            </div>
